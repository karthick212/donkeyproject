  ...
  <!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Courier Company</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Courier Company</li>
            </ol>
          </div><!-- /.col -->
...
<div class="card">
              <div class="card-header">
                <h3 class="card-title text-right"><router-link :to="{ name: 'CourierCompanyadd' }" class="btn btn-primary">Add Courier</router-link></h3>
              </div>
              <!-- /.card-header -->
