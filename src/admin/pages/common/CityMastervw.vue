  ...
  <!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">City Master</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<div class="card">
              <div class="card-header">
                <h3 class="card-title text-right"><router-link :to="{ name: 'CityMasteradd' }" class="btn btn-primary">Add City</router-link></h3>
              </div>
              <!-- /.card-header -->
...
/* eslint-disable */
  ...
  methods:{ FetchItem(){
     let uri = this.$hostName+ '/courier/ProductType';
  ...
  if(r==true){
     let uri = this.$hostName+ '/courier/ProductType/Del/'+id1;
     console.log("Del"+id1);
